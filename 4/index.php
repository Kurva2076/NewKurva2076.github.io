...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $error_messages = [
        'fullName' => [
            400 => 'Введите ФИО.',
            401 => 'ФИО не может быть длинее 150 символов.',
        ...
        'phoneNumber' => [
            ...
            401 => 'Номер телефона не может быть длинее 30 символов.',
        ...
        'email' => [
            400 => 'Введите e-mail.',
            401 => 'E-mail должен быть не длинее 150 символов.',
            ...
            417 => 'Код страны не можеть быть пустым.'
        ],
        'birth' => [
    ...
    // вместо strlen сделать mb_strlen и посмотреть что будет
